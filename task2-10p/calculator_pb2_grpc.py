...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Exponentiate = channel.unary_unary(
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Exponentiate': grpc.unary_unary_rpc_method_handler(
                    servicer.Exponentiate,
                    request_deserializer=calculator__pb2.Request.FromString,
                    response_serializer=calculator__pb2.Response.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def Exponentiate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Calculator/Exponentiate',
            calculator__pb2.Request.SerializeToString,
            calculator__pb2.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
